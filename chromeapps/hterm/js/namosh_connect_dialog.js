...
/**
 * Window onLoad handler for namosh_connect_dialog.html.
 */
window.onload = function() {
  lib.ensureRuntimeDependencies();
  window.dialog_ = new namosh.ConnectDialog();
};
...
namosh.ConnectDialog = function() {
  ...
  // The namosh global pref manager.
  ...
  this.emptyProfileRecord_ = new namosh.ConnectDialog.ProfileRecord(
      'new', null, '[New Connection]');

  // Map of id->namosh.ConnectDialog.ProfileRecord.
  this.profileMap_ = {};

  // Array of namosh.ConnectDialog.ProfileRecord instances in display order.
  this.profileList_ = [];
 ...
 */
namosh.ConnectDialog.ProfileRecord = function(id, prefs, opt_textContent) {
  this.id = id;
  this.prefs = prefs;
 ...
 */
namosh.ConnectDialog.prototype.msg = function(name, opt_args) {
  if (!this.mm_)
    return 'loading...';
 ...
 * the same length.
 */
namosh.ConnectDialog.prototype.alignLabels_ = function() {
  var labels = [
      this.$f('identity').previousElementSibling,
      this.$f('mosh-server').previousElementSibling,
 ...
 */
namosh.ConnectDialog.prototype.installHandlers_ = function() {
  ...
  ['argstr', 'terminal-profile', 'mosh-server'
  ].forEach(function(name) {
      var field = this.$f(name)
      addListeners(field,
  ...
  ['description', 'username', 'hostname', 'port', 'mosh-server', 'identity',
 ...
 */
namosh.ConnectDialog.prototype.$f = function(
 ...
 */
namosh.ConnectDialog.prototype.setCurrentProfileRecord = function(
    profileRecord) {
 ...
 * disabled property.
 */
namosh.ConnectDialog.prototype.enableButton_ = function(button, state) {
  if (state) {
 ...
 */
namosh.ConnectDialog.prototype.save = function() {
  ...
  if (dirtyForm) {
    ...
    if (!prefs) {
      ...
      var rec = new namosh.ConnectDialog.ProfileRecord(
 ...
 */
namosh.ConnectDialog.prototype.connect = function(name, argv) {
 ...
 */
namosh.ConnectDialog.prototype.postMessage = function(name, argv) {
 ...
 * pref value.
 */
namosh.ConnectDialog.prototype.maybeDirty_ = function(fieldName) {
 ...
 * to bulk-default.
 */
namosh.ConnectDialog.prototype.maybeCopyPlaceholders_ = function() {
  ['description', 'username', 'hostname', 'port'
 ...
 */
namosh.ConnectDialog.prototype.maybeCopyPlaceholder_ = function(fieldName) {
 ...
 */
namosh.ConnectDialog.prototype.updatePlaceholders_ = function(fieldName) {
 ...
 */
namosh.ConnectDialog.prototype.updateDetailPlaceholders_ = function() {
 ...
 */
namosh.ConnectDialog.prototype.updateDescriptionPlaceholder_ = function() {
 ...
 */
namosh.ConnectDialog.prototype.syncForm_ = function() {
  ['description', 'username', 'hostname', 'port', 'argstr', 'mosh-server',
 ...
 */
namosh.ConnectDialog.prototype.syncIdentityDropdown_ = function(opt_onSuccess) {
  var keyfileNames = [];
 ...
 */
namosh.ConnectDialog.prototype.deleteIdentity_ = function(identityName) {
  var count = 0;
 ...
 */
namosh.ConnectDialog.prototype.syncProfiles_ = function() {
  ...
  for (var i = 0; i < ids.length; i++) {
    ...
    if (!p) {
      p = this.profileMap_[id] = new namosh.ConnectDialog.ProfileRecord(
 ...
 */
namosh.ConnectDialog.prototype.onMessagesLoaded_ = function(mm, loaded, failed) {
  this.mm_ = mm;
 ...
 */
namosh.ConnectDialog.prototype.onFileSystemFound_ = function(
 ...
 */
namosh.ConnectDialog.prototype.onImportFiles_ = function(e) {
 ...
 */
namosh.ConnectDialog.prototype.onShortcutListKeyDown_ = function(e) {
 ...
 */
namosh.ConnectDialog.prototype.onProfileIndexChanged = function(e) {
 ...
 */
namosh.ConnectDialog.prototype.onConnectClick_ = function(e) {
 ...
 * Someone clicked on the connect button.
 */
namosh.ConnectDialog.prototype.onDeleteClick_ = function(e) {
 ...
 */
namosh.ConnectDialog.prototype.onFormKeyUp_ = function(e) {
 ...
 * this twice.
 */
namosh.ConnectDialog.prototype.onFormFocusChange_ = function(e) {
 ...
 */
namosh.ConnectDialog.prototype.onProfileListChanged_ = function() {
 ...
 */
namosh.ConnectDialog.prototype.onDescriptionChanged_ = function(
    value, name, prefs) {
 ...
 */
namosh.ConnectDialog.prototype.onMessage_ = function(e) {
 ...
 */
namosh.ConnectDialog.prototype.onMessageName_ = {};

/**
 * termianl-info: The terminal introduces itself.
 */
namosh.ConnectDialog.prototype.onMessageName_['terminal-info'] = function(info) {
 ...
 */
namosh.ConnectDialog.prototype.onWindowMessage_ = function(e) {
